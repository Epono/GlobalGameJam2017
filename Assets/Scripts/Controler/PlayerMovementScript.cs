...
public class PlayerMovementScript : NetworkBehaviour
{
    ...
    void Update()
    {
        ...
        //Debug.Log("NETWORK COUNT : " + NetworkServer.localConnections.Count);
        //if (Network.isServer)
        //{
        //    if (NetworkServer.connections.Count < 2 && Time.timeSinceLevelLoad > 10.0f)
        //    {
        //        Network.Disconnect();
        //        SceneManager.LoadScene("YOUWIN");
        //    }
    ...
    void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        else if (hit.tag == "ISLAND")
        {
            ...
            {
                health.HealthPoint--;
                TakeDamage(health.DamageToGive);
